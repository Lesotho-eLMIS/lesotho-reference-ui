...
(function() {
    ...
    physicalInventoryTypeToggleController.$inject = ['messageService'];

    function physicalInventoryTypeToggleController(messageService) {
        ...
        function getMessage(unit) {
            return messageService.get(unit);
        }
