...
(function () {
  ...
  function service(messageService) {
    ...
    function recalculateSOHQuantity(stockOnHand, netContent, inDoses) {
      ...
      var packs =
        stockOnHand > 0
          ? Math.floor(stockOnHand / netContent)
          : Math.ceil(stockOnHand / netContent);
      ...
      if (remainderDoses > 0) {
        return (
          ...
          " ( +" +
          remainderDoses +
          messageService.get("openlmisInputDosesPacks.DosesBracket")
        );
      }
      return (
        packs +
     ...
     */
    function getTotalQuantityInDoses(
      quantityInPacks,
      ...
      if (
        quantityInPacks !== undefined &&
        quantityInPacks !== null &&
        !isNaN(quantityInPacks)
      ) {
